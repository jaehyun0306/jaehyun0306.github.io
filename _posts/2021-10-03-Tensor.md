...
텐서는 일관된 유형(dtype이라고 불리는)을 가진 다차원 배열입니다. 지원되는 모든 dtypes은 tensorflow.dtypes.Dtype에서 볼수 있습니다.
...
![scalar.png](https://github.com/jaehyun0306/jaehyun0306/blob/main/%EC%8A%A4%EC%B9%BC%EB%9D%BC.PNG)
